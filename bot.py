"""
V14 FINAL MADINAH EDITION - 100% WAKTU MADINAH
- Live 4478 real time
- Trend per TF M1 M5 M15 H1 H4 D1
- Macro DXY US10Y PCE CPI NFP
- COT, SR, Pivot, OrderBlock, Psikologi
- Anti Bentrok Histori + Realtime
- SEMUA JAM = WAKTU MADINAH AST (UTC+3)
...
def main():
    ...
    print(f"=== V14 MADINAH {now_saudi().strftime('%H:%M AST')} STARTED ===")
    app.run_polling()
